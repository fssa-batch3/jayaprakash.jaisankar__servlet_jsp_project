...
tododivcompleted.innerHTML = `    <span id="taskstatus1" style="background-color:#8BC34A; color:black;">Completed</span>
     ...
     <p id="noresultsfound-p" style="display:none;">Completed Project <br>Section Is Empty</p>
     </div>`;
...
tododivworking.innerHTML = `    <span id="taskstatus1" style="background-color:#FFC107; color:black;" >Currently Working</span>
     ...
     <p id="noresultsfound2-p" style="display:none;">Currently Working  <br>Section Is Empty</p>
     </div>`;
...
tododivnotcompleted.innerHTML = `    <span id="taskstatus1" style="background-color:#F44336; color:white;" >Not Completed (Incomplete)</span>
     ...
     <p id="noresultsfound3-p" style="display:none;">Not Completed (Incomplete)  <br>Section Is Empty</p>
     </div>`;
...
tododivnotyetstarted.innerHTML = `    <span id="taskstatus1" style="background-color:#9E9E9E; color:white;" >Not Yet Started</span>
     ...
     <p id="noresultsfound4-p" style="display:none;">Not Yet Started  <br>Section Is Empty</p>
     </div>`;
...
for (let i = findUser["mytodos"].length - 1; i >= 0; i--) {
  ...
  tododiv.setAttribute(
    "href",
    "../pages/tododetails.jsp?id=" + findUser["mytodos"][i]["todoID"]
  );
 ...
 <div class="task-div">
  ...
  <a id="taskassignee1" href="mailto:${
    ...
    <p id="taskpriority1" class="taskpriority1" ><i class="bx bx-circle" id="bx-circle-${i}"></i> ${
  ...
  if (findUser["mytodos"][i]["taskstatus"] === "Completed") {
    ...
    findUser["mytodos"][i]["taskstatus"] === "Not Completed (Incomplete)"
  ) {
...
logoutbtn.addEventListener("submit", (event) => {
  ...
  if (msg === true) {
    ...
    let newWindow = window.open("../index.jsp", "noopener,noreferrer");
    window.close();
    newWindow.focus();
  }
});
