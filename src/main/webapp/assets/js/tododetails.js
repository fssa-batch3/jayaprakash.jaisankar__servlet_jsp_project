...
form.addEventListener("click", (event) => {
  ...
  document.getElementById("addtask").innerText =
    "Project task  Edited Successfully";

  alert("Project task Successfully Edited");

  window.location.href = "mytodo.jsp";
});
...
deletetask.addEventListener("click", (event) => {
  ...
  let msg = confirm("Are you sure You want to Delete this project  task ?");
