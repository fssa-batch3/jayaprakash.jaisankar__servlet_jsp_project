                        ...
                        <div class="row g-2">
                            <div class="col-lg-3">
                                <div class="filler-job-form">
                                    ...
                                    <input id="exampleFormControlInput1" type="search" class="form-control filler-job-input-box" placeholder="Job, Company name..." />
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="filler-job-form">
                            ...
                            <div class="col-lg-3">
                                <div>
                                    ...
                                    <a class="btn btn-success ms-2" href="#"><i class="uil uil-cog"></i> Advance</a>
                                </div>
                            </div>
                        </div>
                    </form>
                            ...
                            <div class="align-items-center row">
                                ...
                                <div class="col-lg-4">
                                    <div class="mt-2 mt-lg-0 d-flex flex-wrap align-items-start gap-1">
                                        <span class="primary-link" href="#">Experience </span>
                                        &emsp;
