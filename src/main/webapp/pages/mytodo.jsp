...
<html lang="en">
  ...
  <body>
    ...
    <section class="home-section">
      ...
      <h1 class="todohead">My Project's</h1>
      <div id="todo-container" class="app"></div>

      <!-- display none when click add new task it becomes display block -->
      <div id="popupOverlay">
        <div id="popupContent">
          <h2 class="newtaskh1">Add New Project</h2>
          <br />
          ...
          <form id="form">
            <div id="overflow">
              ...
              >
                ...
                <option value="Personal Tasks">Personal</option>
                <option value="Work/Professional Tasks">
                  Work/Professional
                </option>
                <option value="Academic Tasks">Academic</option>

                <option value="Social/Event Tasks">Social/Event</option>
              </select>
              <br />
              <div class="form-floating mb-3" id="firstinput">
                <input
    ...
    <script src="<%=request.getContextPath()%>/assets/js/mytodo.js"></script>
  </body>
</html>
